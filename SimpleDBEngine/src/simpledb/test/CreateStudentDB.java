...
public class CreateStudentDB {
	public static void main(String[] args) {
		...
		try (Connection conn = d.connect(url, null); Statement stmt = conn.createStatement()) {
			...
			stmt.executeUpdate(s);
			System.out.println("Index on STUDENT.MajorId created.");
			...
			s = "create index idx_deptid on COURSE(DeptId)";
			stmt.executeUpdate(s);
			System.out.println("Index on COURSE.DeptId created.");
			...
			s = "create index idx_courseid on SECTION(CourseId)";
			stmt.executeUpdate(s);
			System.out.println("Index on SECTION.CourseId created.");
			...
			s = "create index idx_studentid on ENROLL(StudentId)";
			stmt.executeUpdate(s);
			s = "create index idx_sectionid on ENROLL(SectionId)";
			stmt.executeUpdate(s);
			System.out.println("Indexes on ENROLL.StudentId and ENROLL.SectionId created.");
